            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        ...
                        <p class="text-lead text-white"> {{env('APP_NAME')}}</p>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    <div class="flex flex-col mb-3 col-6">
                                        <input type="text" name="first_name" class="form-control"
                                               ...
                                               aria-label="Name" value="{{ old('first_name') }}">
                                        @error('first_name') <p
                                            class='text-danger text-xs pt-1'> {{ $message }} </p> @enderror
                                    </div>
                                    <div class="flex flex-col mb-3 col-6">
                                        <input type="text" name="last_name" class="form-control" placeholder="Last Name"
                                               aria-label="Name" value="{{ old('last_name') }}">
                                        @error('last_name') <p
                                            class='text-danger text-xs pt-1'> {{ $message }} </p> @enderror
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="flex flex-col mb-3 col-6">
                                        <input type="number" name="phone_number" class="form-control"
                                               ...
                                               aria-label="Phone Number" value="{{ old('phone_number') }}">
                                        @error('phone_number')
                                ...
                                <div class="row">
                                    ...
                                    <div class="flex flex-col mb-3 col-6">
                                        <input type="text" name="city" class="form-control" placeholder="City"
                                               aria-label="City" value="{{ old('city') }}">
                                        @error('city') <p
                                            class='text-danger text-xs pt-1'> {{ $message }} </p> @enderror
                                    </div>
                                </div>
